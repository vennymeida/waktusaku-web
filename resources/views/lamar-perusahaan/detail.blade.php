                            ...
                            <ul class="list-unstyled">
                                ...
                                @if ($pendidikan && $pendidikan->count() > 0)
                                    ...
                                    <dl class="row">
                                        ...
                                        <dd class="col-sm-8 mt-2">{{ optional($pendidikan->first())->institusi ?: '-' }}
                                        </dd>

                                        <dt class="col-sm-4 mt-2">Gelar</dt>
                                        <dd class="col-sm-8 mt-2">{{ optional($pendidikan->first())->gelar ?: '-' }}</dd>

                                        <dt class="col-sm-4 mt-2">Jurusan</dt>
                                        <dd class="col-sm-8 mt-2">{{ optional($pendidikan->first())->jurusan ?: '-' }}</dd>
                                                    ...
                                                    @foreach ($pendidikan as $pendidikanItem)
                                                        <dl class="row">
                                                            ...
                                                            <dd class="col-sm-8 mt-2">
                                                                ...
                                                                {{ optional($pendidikanItem)->tahun_berakhir ?: '' }}</dd>
                                                        </dl>
                                                        <hr class="my-4">
                                                    @endforeach
                                                </div>
                                ...
                                @if ($pengalaman && $pengalaman->count() > 0)
                                    <dl class="row">
                                        ...
                                        <dt class="col-sm-4 mt-2">Alamat</dt>
                                        <dd class="col-sm-8 mt-2">{{ optional($pengalaman->first())->alamat ?: '-' }}</dd>

                                        <dt class="col-sm-4 mt-2">Tipe Pekerjaan</dt>
                                        <dd class="col-sm-8 mt-2">{{ optional($pengalaman->first())->tipe ?: '-' }}</dd>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    @foreach ($pengalaman as $pengalamanItem)
                                                        <dl class="row">
                                                            <dt class="col-sm-4 mt-2">Nama Pekerjaan</dt>
                                                            <dd class="col-sm-8 mt-2">
                                                                {{ optional($pengalamanItem)->nama_pekerjaan ?: '-' }}</dd>
                                ...
                                @if ($pelatihan && $pelatihan->count() > 0)
                                    <dl class="row">
                                        ...
                                        <dd class="col-sm-8 mt-2">{{ optional($pelatihan->first())->deskripsi ?: '-' }}
                                        </dd>
