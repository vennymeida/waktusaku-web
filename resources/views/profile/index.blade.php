                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 col-12" id="foto_upload_form"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="text-warning small">(File type : jpeg,png,jpg | Max size : 2MB)
                                                </div>
                                        ...
                                        @if (Auth::user()->hasRole('Pencari Kerja'))
                                            <div class="form-group col-md-12 col-12" id="resume_upload_form"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="text-warning small">(File type : pdf | Max size : 2MB)
                                                    </div>
                                            ...
                                            <div class="form-group col-md-6 col-12">
                                                ...
                                                <div>
                                                    <a href="#" class="btn btn-sm btn-primary btn-icon"
                                                        ...
                                                        data-logo="{{ Storage::url(Auth::user()->perusahaan->logo) }}">
